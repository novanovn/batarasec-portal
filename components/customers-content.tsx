  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[380px_1fr]">
        <form onSubmit={createCustomer} className="rounded-2xl border border-border bg-card p-6 shadow-2xl space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs uppercase tracking-widest text-zinc-500 mb-1.5 font-semibold">Initial Status</label>
              <select
                value={form.status}
